#!/usr/bin/env python3
"""Module containing functions that calculates the inverse matrix of a
matrix."""
...
def inverse(matrix):
    ...
    Args:
        matrix (list[list]): A list of lists whose inverse matrix should be
            calculated.

    Returns:
        inverse_matrix (list[list], None): Inverse matrix of matrix, or None if
            matrix is singular.
    """
